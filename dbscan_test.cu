...
int main(int argc, char **argv) {
  ...
  */
   ...
   */
   ...
   printf("Indexing sorting and adjusting data started.\n");
  ...
  printf("Indexing sorting and adjusting data ended.\n");
